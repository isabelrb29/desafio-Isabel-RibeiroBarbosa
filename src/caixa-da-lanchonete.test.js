...
describe('CaixaDaLanchonete', () => {
    ...
    test.each([
        ...
        ['compra multipla com código inexistente','debito','Item inválido!',['cafe,1','sanduiche,1','morango, 1']],
    ...
    test.each([
        ...
        //teste novo adicionado
        ['queijo sem o principal em compra multipla','debito','Item extra não pode ser pedido sem o principal',['chantily,1', 'cafe,1','queijo,1']],
    ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));
});
